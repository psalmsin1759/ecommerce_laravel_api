                                                    ...
                                                    <table border="0" width="100%" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center"><img width="100"
                                                                    ...
                                                                    alt="img"
                                                                    src="https://emailmug.com/premium-template/emailpaws/notif/cr.png">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="20">&nbsp;</td>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" width="100%" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td height="20"
                                                                style="border-bottom: 1px solid #e0e0e0">&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            <td height="20">&nbsp;</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                ...
                                                                <table border="0" width="280" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;line-height: 24px;">
                                                                            Subtotal</td>
                                                                        <td>&nbsp;</td>
                                                                        <td align="right"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 18px;color: #282828;font-weight: 600;line-height: 24px;">
                                                                            Total</td>
                                                                        <td>&nbsp;</td>
                                                                        <td align="right"
                                                                            style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 18px;color: #282828;">
                                                    ...
                                                    <table border="0" width="100%" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <table border="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 18px;color: #282828;">
                                                                                                    Shipping Info</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td height="18">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td
                                                                                                    style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 13px;color: #282828;line-height: 22px;">
                                                                                                    {{ $order->first_name }}
                                                                                                    <br>{{ $order->email }}
                                                                                                    <br>{{ $order->phone }}
                                                                                                    <br>{{ $order->shipping_address }}
                                                                                                    <br>{{ $order->shipping_postalcode }}
                                                                ...
                                                                <!-- gap -->
                                                                <table class="row"
                                                                    style="width:50px;max-width:50px;" width="50"
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" border="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="25">
                                                                            <img width="25"
                                                                                style="display:block;width:100%;max-width:25px;"
                                                                                src="http://emailmug.com/premium-template/emailpaws/notif/pi.png">
                                                                        </td>
                                                                    </tr>
                                                                </table>
