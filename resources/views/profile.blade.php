        ...
        <div class="row g-3">
                ...
                <div class="card profile-card flex-column mb-3">
                    ...
                    <div class="card-body d-flex profile-fulldeatil flex-column">
                        <div class="profile-block text-center w220 mx-auto">
                            <a href="#">
                                <img src="{{asset("dashboardassets/images/lg/avatar4.svg")}}" alt="" class="avatar xl rounded img-thumbnail shadow-sm">
                            </a>
                        ...
                        <div class="profile-info w-100">
                            <h6  class="mb-0 mt-2  fw-bold d-block fs-6 text-center">{{-- {{$admin->full_names}} --}}</h6>
            ...
            <div class="col-xl-8 col-lg-7 col-md-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form method="POST"  action="{{url("/vendor/profile/edit")}}" >
                            {{ csrf_field() }}
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="name" id="first" value="{{-- {{$admin->full_names}} --}}" type="text" class="form-control" placeholder="First Name :">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label">Email <span class="text-danger">*</span></label>
                                    <input name="email" value="{{-- {{$admin->email}} --}}" id="email" type="email" class="form-control" placeholder="Your email :">
                                </div>
                            </div>
                ...
                <div class="card auth-detailblock">
                    ...
                    <div class="card-body">
                        <form method="POST"  action="{{url("/vendor/profile/password")}}" >
                            {{ csrf_field() }}
                            <input name="id" type="hidden" value="{{-- {{$admin->id}} --}}" />
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label">Old password <span class="text-danger">*</span></label>
                                    <input type="password" name="password" class="form-control ps-5" placeholder="Old password" required="">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
