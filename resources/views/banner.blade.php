            ...
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    ...
                    <div class="col-auto d-flex w-sm-100">
                        <button type="button" class="btn btn-primary btn-set-task w-sm-100" data-bs-toggle="modal" data-bs-target="#expadd"><i class="icofont-plus-circle me-2 fs-6"></i>Add Banner</button>
                    </div>
                </div>
            </div>
        </div> <!-- Row end  -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                            <button type="button" class="btn btn-outline-secondary edit-slider"  data-bs-toggle="modal" data-bs-target="#banneredit" data-id="{{$item->id}}" data-title="{{$item->title}}" data-subtitle="{{$item->subtitle}}" data-sort="{{$item->sort_order}}"  data-created="{{$item->created_at}}" ><i class="icofont-edit text-success"></i></button>
                                            <a type="button" class="btn btn-outline-secondary delete-banner" data-id="{{$item->id}}"><i class="icofont-ui-delete text-danger"></i></a>
                                        </div>
                                    </td>

                                    <td> <img style="width: 249px; height: 150px" src="{{asset("images/banner/" . $item->image_path)}}" width="20px" height="20px"/>  </td>
